...
int main(){
	...
	while(1){
		...
		case 1: 
			...
			cout<<")\n";
			break;
		case 2: cout<<"Maximum: "<<findMax(root)<<'\n';
			break;
		case 3: cout<<"Minimum: "<<findMin(root)<<'\n';
			break;
		case 4: cout<<"Median: "<<findMedian(root)<<'\n';
			break;
		case 5: cout<<"List in non-decreasing order: ";
			incOrder(root);
			cout<<'\n';
			break;
		case 6: cout<<"Program exits";
			return 0;
		}
	}
